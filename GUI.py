...
from devices import MIN_TDP,STEP_ONE,STEP_TWO,MAX_TDP
    ...
    match system_name:
       case "ONE XPLAYER":
           ...
           IMAGE_1 = pygame_gui.elements.UIImage(
                                       ...
                                       image_surface= pygame.image.load('assets/images/oxp-ctr.png').convert_alpha(),
                                       manager=manager
           )
       ...
       case "AYA NEO":
           ...
           IMAGE_1 = pygame_gui.elements.UIImage(
                                       relative_rect=pygame.Rect(375,250,525,325),
                                       image_surface= pygame.image.load('assets/images/aya-neo-ctr.png').convert_alpha(),
                                       manager=manager
         )
       case "Steam Deck":
          MIN_BUTTON = pygame_gui.elements.UIButton(
